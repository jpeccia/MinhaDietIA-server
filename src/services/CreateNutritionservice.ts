...
class CreateNutritionService {
    async execute( name, weight, height, age, gender, objective, level, foodPreference, numberMeals, foodRestrictions){
        try {
            ...
            const response = await model.generateContent(`Imagine que você é um nutricionista esportivo. 
                ...
                com tais restrições alimentares: ${foodRestrictions}, e com essa quantidade de vezes para comer no dia: ${numberMeals} e faça um calculo das suas calorias diarias baseadas 
                ...
                propriedade peso, propriedade objetivo com o objetivo atual, propriedade refeições com uma array contendo dentro cada objeto 
                ...
                sugestão de suplemento que é indicado para o sexo dessa pessoa e o objetivo dela e não retorne nenhuma observação alem das passadas no prompt, retorne em 
